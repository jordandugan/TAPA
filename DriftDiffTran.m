...
Simulation = 'GradedJunction';
%Simulation = 'LinearDope';
%Simulation = 'ExponentialDope';
...
elseif strcmp(Simulation, 'LinearDope')
    eval('SetLinearDope');
elseif strcmp(Simulation, 'ExponentialDope')
    eval('SetExponentialDope');
elseif strcmp(Simulation, 'GradedJunction')
    eval('SetGradedJunction');
end
